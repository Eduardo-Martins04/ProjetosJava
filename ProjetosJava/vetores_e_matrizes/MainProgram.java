...
public class MainProgram {
    ...
    public int subtrairVetorDeInteiros(){
        ...
        for (int i = 0; i < vetorDeInteiros.length; i++){
            subtracao = subtracao - vetorDeInteiros[i];
    ...
    public int subtrairMatrizDeInteiros(){
        ...
        if(matriz3x3 != null){
            if(matriz3x3.length > 0){
                for (int i = 0; i < TAMANHO_MATRIX_DUAS_DIMENSOES; i ++){
                    for (int j = 0; j < TAMANHO_MATRIX_DUAS_DIMENSOES; j++){
                        subtracao = subtracao - matriz3x3[i][j];
                    }
                }
            }
        }
